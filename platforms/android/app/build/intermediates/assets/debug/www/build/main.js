...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, http, inAppBrowser) {
        ...
        this.http.get('https://newsapi.org/v2/top-headlines?' +
            'country=us&' +
            'apiKey=84d3c5bb9143410c95639094e855ab28').map(function (res) { return res.json(); }).subscribe(function (data) {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/bharat/news/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>News</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content >\n <ion-item>\n    <ion-label floating>URL</ion-label>\n    <ion-input type="url" [(ngModel)]="url"></ion-input>\n  </ion-item>\n    <button ion-button block clear (click)="openWebpage(url)">Open Webpage</button>\n\n\n<ion-card *ngFor="let post of posts">\n  <img src="{{post.urlToImage}}"    (tap)="tapEvent($event)" />\n  <ion-card-content>\n    <ion-card-title class="card-title">\n      {{post.title}}\n      </ion-card-title>\n<!--     <p>\n      {{post.description}}\n    </p> -->\n  </ion-card-content>\n  <ion-item>\n  <p> {{ post.publishedAt | date : "dd/MM/yyyy hh:mma" : UTC}} </p>\n  <a href="{{post.url}}">More</a>\n  </ion-item>\n    \n    <ion-item>\n      Clicked: {{tap}} times\n	</ion-item>\n\n</ion-card>\n</ion-content>\n\n'/*ion-inline-end:"/home/bharat/news/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_in_app_browser__["a" /* InAppBrowser */]])
    ], HomePage);
    return HomePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_in_app_browser__ = __webpack_require__(196);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/bharat/news/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/bharat/news/src/app/app.html"*/
        }),
